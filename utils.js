...
const setCardBackground = (quantity) => { return quantity === "Más de 10" ? "violet-card" : quantity === "Entre 5 y 10" ? "red-card" : "black-card";
};

const setCardImg = (quantity) => { return quantity === "Más de 10" ? "./assets/img/server.png" : quantity === "Entre 5 y 10" ? "./assets/img/laptop.png" : "./assets/img/lupa.png";
};

const setCardImgClass = (quantity) => { return quantity === "Más de 10" ? "sever-img" : quantity === "Entre 5 y 10" ? "laptop-img" : "lupa-img";
};
